# Gabriel Ternero: Portfolio HTML+CSS

## Proyecto: Portfolio Personal en HTML

Crea un **portfolio personal** utilizando **HTML5** que presente tu información profesional y académica de forma ordenada, clara y navegable. El objetivo es demostrar tu capacidad para estructurar contenido web correctamente usando las etiquetas adecuadas.
...
- Calidad de la información Claridad, coherencia y organización del contenido personal. - / 2
- Navegación Navegación funcional entre secciones/páginas; enlaces correctos. - / 1
- Buenas prácticas técnicas Código correctamente indentado, limpio y entendible. - / 1
- Estilo visual (opcional) Uso de CSS para mejorar presentación (solo suma si se usa). - / 1
